        ...
        <div class="meetup-lookup centered">
          <div class="level">
            <div class="level-left">
              ...
              <div class="level-item">
                <span>Meetups in San Francisco, USA</span>
              </div>
            </div>
            <div class="level-right">
              <div class="level-item">
                <button class="button is-medium m-r-sm">Reuniones</button>
                <button class="button is-medium">Calendario</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section page-find">
        <div class="columns cover is-multiline">
          <div v-for="meetup of meetups" :key="meetup._id" class="column is-one-third" :style="{'min-height': '160px'}">
            <router-link :to="'/encuentro/' + meetup._id" class="meetup-card-find"
               href="#"
              ...
              <div class="meetup-card-find-content">
                ...
                <div class="meetup-card-find-content-info">
                  ...
                  <span class="tag badge-black m-b-xs">{{meetup.category.name | capitalize}}</span>
        ...
        <div>
          <span class="tag badge-black is-large">No se encontraron reuniones :( Podría intentar cambiar los criterios de búsqueda (:</span>
        </div>
      </section>
    </div>
  </div>
